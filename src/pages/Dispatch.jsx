...
<Container fluid>
    ...
    <div className='valuedelivered-maindiv-dispatch'>
  <div className='valuedelivered-firstdiv-dispatch'>
  ...
  <div className='valuedelivered-seconddiv-dispatch'>
    <img src={efficiency} alt="" />
    <h6>Real-Time Visibility into the Quality Status </h6>
    <p>With our PURVEY WMS, you gain real-time visibility into the quality status of your inventory. You can track and monitor quality checkpoints, identify potential issues, and take proactive measures to resolve them,compliant and high-quality products are dispatched.

</p>
  </div>
  <div className='valuedelivered-thirddiv-dispatch'>
    <img src={improvedorderaccuracy} alt="" />
    <h6>Generates Automated Quality Alerts </h6>
    <p>PURVEY WMS generates automated quality alerts whenever a deviation or non-conformance is detected during the inspection process. This enables timely corrective actions, reducing the risk of  substandard products and maintaining your reputation for delivering superior quality.</p>
  </div>
  <div className='valuedelivered-firstdiv-dispatch'>
    <img src={improveresouceutilisation} alt="" />
